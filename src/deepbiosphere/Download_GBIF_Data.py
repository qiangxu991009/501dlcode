...
def request_gbif_records(gbif_usr, email, taxon, start_date="2015", end_date="2025", area=['USA.23.85_1']):
...
if __name__ == "__main__":
    ...
    args.add_argument('--area', type=str, help='GADM area code for where observations should be taken from', default=['USA.23.85_1'])
